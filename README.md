...
- **v1.1:** Planung gestartet (Validation, Enablement & Operational Maturity; nicht released, kein Scope Lock) — [v1.1 Plan](docs/roadmap/V1_1_PLAN.md) · aktueller WP: **WP-153 – Prompt Execution Contract Baseline** (aktiv / im Review — Annahme erst durch Nova-Review + Human-Maintainer-Commit; [Execution Contract](framework/prompts/blocks/BLOCK_EXECUTION_CONTRACT.md)); danach, erst nach Annahme: WP-154 – Skills Pack P0 Hardening; WP-151 und WP-152 ([Guide](docs/guides/TOKEN_EFFICIENCY_AND_CONTEXT_BUDGET_BASELINE.md)) abgeschlossen
...
- **v1.1:** planning started (Validation, Enablement & Operational Maturity; not released, no scope lock) — [v1.1 plan](docs/roadmap/V1_1_PLAN.md) · current WP: **WP-153 – Prompt Execution Contract Baseline** (active / under review — accepted only via Nova review + Human-Maintainer commit; [execution contract](framework/prompts/blocks/BLOCK_EXECUTION_CONTRACT.md)); next, only after acceptance: WP-154 – Skills Pack P0 Hardening; WP-151 and WP-152 ([guide](docs/guides/TOKEN_EFFICIENCY_AND_CONTEXT_BUDGET_BASELINE.md)) completed
