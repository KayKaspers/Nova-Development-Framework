...
- **Foundation 0.7:** ist scope-locked — v1.0-Pfad-Konsolidierung & Kompatibilitäts-Governance; [v1.x Compatibility Policy](docs/adr/ADR-0031-v1x-compatibility-policy.md) angenommen (volle Zusage erst mit v1.0), kein v1.0 — [Plan](docs/roadmap/FOUNDATION_0_7_PLAN.md) · [Scope Lock](docs/roadmap/FOUNDATION_0_7_SCOPE_LOCK.md) · [WP-Queue](docs/roadmap/FOUNDATION_0_7_WORK_PACKAGES.md)
...
- **Foundation 0.7:** is scope-locked — v1.0 path consolidation & compatibility governance; [v1.x compatibility policy](docs/adr/ADR-0031-v1x-compatibility-policy.md) accepted (full promise activates only at v1.0), not v1.0 — [Plan](docs/roadmap/FOUNDATION_0_7_PLAN.md) · [Scope Lock](docs/roadmap/FOUNDATION_0_7_SCOPE_LOCK.md) · [WP queue](docs/roadmap/FOUNDATION_0_7_WORK_PACKAGES.md)
