...
- **Foundation 0.9:** Planung gestartet als Kandidatenphase für Adoption, Validation & Optional Enablement (noch nicht scope-locked, nicht released, kein v1.0, kein aktives Skill Pack) — [Plan](docs/roadmap/FOUNDATION_0_9_PLAN.md) · [WP-Kandidaten](docs/roadmap/FOUNDATION_0_9_WORK_PACKAGES.md)
...
- **Foundation 0.9:** planning started as a candidate phase for Adoption, Validation & Optional Enablement (not yet scope-locked, not released, not v1.0, no active skill pack) — [Plan](docs/roadmap/FOUNDATION_0_9_PLAN.md) · [WP candidates](docs/roadmap/FOUNDATION_0_9_WORK_PACKAGES.md)
