...
- **v1.0.0:** **final released** — vorheriges finales Release (`v1.0.0`, 2026-07-10; die volle [v1.x Compatibility Policy](docs/adr/ADR-0031-v1x-compatibility-policy.md) ist ab v1.0.0 aktiv und bleibt aktiv) — [Final Release Notes](docs/release/V1_0_FINAL_RELEASE_NOTES.md) · [Post-Release Review](docs/validation/v1-0/V1_0_FINAL_POST_RELEASE_REVIEW.md) · [v1.0-Pfad](docs/roadmap/V1_0_PATH_SUMMARY.md) · **38 docs-only Skills:** [.claude/skills/](.claude/skills/README.md)
- **v1.1.0:** **released 2026-09-23 — neueste released Version** (Minor Release, kein Pre-Release; Validation, Enablement & Operational Maturity; Human-Maintainer-Release-Entscheidung **`GO_WITH_NOTES`** vom 2026-09-23 — die bekannten Grenzen gehen ungelöst mit, u. a. **G-13 `MATERIALLY_REDUCED` — nicht geschlossen**; voll kompatibel mit der aktiven v1.x-Zusage, kein Breaking Change, weiterhin 38 docs-only Skills) — [Release Notes](docs/release/V1_1_0_RELEASE_NOTES.md) · [Go/No-Go](docs/release/V1_1_0_GO_NO_GO.md) · [v1.1 Plan](docs/roadmap/V1_1_PLAN.md) · abgeschlossen: WP-151…159 — WP-151 ([Review](docs/validation/v1-1/SKILLS_REAL_USE_AND_CONTEXT_EFFICIENCY_REVIEW.md)), WP-152 ([Guide](docs/guides/TOKEN_EFFICIENCY_AND_CONTEXT_BUDGET_BASELINE.md)), WP-153 ([Execution Contract](framework/prompts/blocks/BLOCK_EXECUTION_CONTRACT.md)), WP-154 ([Validation](docs/validation/v1-1/SKILLS_PACK_P0_HARDENING.md)), WP-155 ([Validation](docs/validation/v1-1/EXTERNAL_VALIDATION_IMPROVEMENT.md)), WP-156 ([Validation](docs/validation/v1-1/PROJECT_ENABLEMENT_VALIDATION.md)), WP-157 ([Validation](docs/validation/v1-1/PUBLIC_DOCUMENTATION_POLISH.md)), WP-158 ([Readiness Review](docs/validation/v1-1/V1_1_READINESS_REVIEW.md), committed `e37f2c7`), WP-159 ([Release Prep Review](docs/validation/v1-1/V1_1_RELEASE_PREP_REVIEW.md), committed `fcefb47`)
...
- **v1.0.0:** **final released** — the previous final release (`v1.0.0`, 2026-07-10; the full [v1.x compatibility policy](docs/adr/ADR-0031-v1x-compatibility-policy.md) is active from v1.0.0 and remains active) — [Final Release Notes](docs/release/V1_0_FINAL_RELEASE_NOTES.md) · [Post-Release Review](docs/validation/v1-0/V1_0_FINAL_POST_RELEASE_REVIEW.md) · [v1.0 path](docs/roadmap/V1_0_PATH_SUMMARY.md) · **38 docs-only skills:** [.claude/skills/](.claude/skills/README.md)
- **v1.1.0:** **released 2026-09-23 — latest released version** (minor release, not a pre-release; Validation, Enablement & Operational Maturity; Human-Maintainer release decision **`GO_WITH_NOTES`** of 2026-09-23 — the known limitations are carried forward unresolved, including **G-13 `MATERIALLY_REDUCED` — not closed**; fully compatible with the active v1.x promise, no breaking change, still 38 docs-only skills) — [Release Notes](docs/release/V1_1_0_RELEASE_NOTES.md) · [Go/No-Go](docs/release/V1_1_0_GO_NO_GO.md) · [v1.1 plan](docs/roadmap/V1_1_PLAN.md) · completed: WP-151…159 — WP-151 ([review](docs/validation/v1-1/SKILLS_REAL_USE_AND_CONTEXT_EFFICIENCY_REVIEW.md)), WP-152 ([guide](docs/guides/TOKEN_EFFICIENCY_AND_CONTEXT_BUDGET_BASELINE.md)), WP-153 ([execution contract](framework/prompts/blocks/BLOCK_EXECUTION_CONTRACT.md)), WP-154 ([validation](docs/validation/v1-1/SKILLS_PACK_P0_HARDENING.md)), WP-155 ([validation](docs/validation/v1-1/EXTERNAL_VALIDATION_IMPROVEMENT.md)), WP-156 ([validation](docs/validation/v1-1/PROJECT_ENABLEMENT_VALIDATION.md)), WP-157 ([validation](docs/validation/v1-1/PUBLIC_DOCUMENTATION_POLISH.md)), WP-158 ([readiness review](docs/validation/v1-1/V1_1_READINESS_REVIEW.md), committed `e37f2c7`), WP-159 ([release prep review](docs/validation/v1-1/V1_1_RELEASE_PREP_REVIEW.md), committed `fcefb47`)
