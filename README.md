...
- **Foundation 0.7:** befindet sich in Planung — v1.0-Pfad-Konsolidierung & Kompatibilitäts-Governance; der Scope ist noch nicht gesperrt, kein v1.0 — [Plan](docs/roadmap/FOUNDATION_0_7_PLAN.md) · [WP-Kandidaten](docs/roadmap/FOUNDATION_0_7_WORK_PACKAGES.md) · [Kriterien-Draft](docs/release/FOUNDATION_0_7_RELEASE_CRITERIA.md)
...
- **Foundation 0.7:** is in planning — v1.0 path consolidation & compatibility governance; the scope is not locked yet, not v1.0 — [Plan](docs/roadmap/FOUNDATION_0_7_PLAN.md) · [WP candidates](docs/roadmap/FOUNDATION_0_7_WORK_PACKAGES.md) · [Criteria draft](docs/release/FOUNDATION_0_7_RELEASE_CRITERIA.md)
