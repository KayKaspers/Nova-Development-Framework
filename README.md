...
- **Foundation 0.8:** für das geplante `v0.8.0-foundation` Foundation Pre-Release **vorbereitet** (Agent Enablement & Context Economy; [ADR-0032](docs/adr/ADR-0032-skill-security-policy.md) angenommen; Release-prepared / tag pending; noch nicht released, kein v1.0, kein aktives Skill Pack) — [Release Notes](docs/release/FOUNDATION_0_8_RELEASE_NOTES.md) · [Go/No-Go](docs/release/FOUNDATION_0_8_GO_NO_GO_CHECKLIST.md) · [Plan](docs/roadmap/FOUNDATION_0_8_PLAN.md) · [Scope Lock](docs/roadmap/FOUNDATION_0_8_SCOPE_LOCK.md) · [Readiness Review](docs/release/FOUNDATION_0_8_READINESS_REVIEW.md)
...
- **Foundation 0.8:** **prepared** for the planned `v0.8.0-foundation` foundation pre-release (Agent Enablement & Context Economy; [ADR-0032](docs/adr/ADR-0032-skill-security-policy.md) accepted; release-prepared / tag pending; not yet released, not v1.0, no active skill pack) — [Release Notes](docs/release/FOUNDATION_0_8_RELEASE_NOTES.md) · [Go/No-Go](docs/release/FOUNDATION_0_8_GO_NO_GO_CHECKLIST.md) · [Plan](docs/roadmap/FOUNDATION_0_8_PLAN.md) · [Scope Lock](docs/roadmap/FOUNDATION_0_8_SCOPE_LOCK.md) · [Readiness Review](docs/release/FOUNDATION_0_8_READINESS_REVIEW.md)
