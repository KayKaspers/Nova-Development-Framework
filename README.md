...
- **Foundation 0.5:** befindet sich in Planung — fokussiert externe Validierung und Härtung des Wegs Richtung v1.0 — [Plan](docs/roadmap/FOUNDATION_0_5_PLAN.md)
...
- **Foundation 0.5:** is in planning — focuses on external validation and hardening the path toward v1.0 — [Plan](docs/roadmap/FOUNDATION_0_5_PLAN.md)
