...
- **Foundation 0.8:** Planung gestartet als Kandidatenphase für Agent Enablement & Context Economy (noch nicht scope-locked, nicht released, kein v1.0, kein aktives Skill Pack) — [Plan](docs/roadmap/FOUNDATION_0_8_PLAN.md) · [WP-Kandidaten](docs/roadmap/FOUNDATION_0_8_WORK_PACKAGES.md)
...
- **Foundation 0.8:** planning started as a candidate phase for Agent Enablement & Context Economy (not yet scope-locked, not released, not v1.0, no active skill pack) — [Plan](docs/roadmap/FOUNDATION_0_8_PLAN.md) · [WP candidates](docs/roadmap/FOUNDATION_0_8_WORK_PACKAGES.md)
