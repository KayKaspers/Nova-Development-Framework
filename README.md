...
- **Foundation 0.6:** befindet sich in Planung — Adoptionsvertrauen & Governance-Härtung; der Scope ist noch nicht gesperrt — [Plan](docs/roadmap/FOUNDATION_0_6_PLAN.md) · [WP-Kandidaten](docs/roadmap/FOUNDATION_0_6_WORK_PACKAGES.md)
...
- **Foundation 0.6:** is in planning — adoption confidence & governance hardening; the scope is not locked yet — [Plan](docs/roadmap/FOUNDATION_0_6_PLAN.md) · [WP candidates](docs/roadmap/FOUNDATION_0_6_WORK_PACKAGES.md)
