...
- **v1.1:** Planung gestartet (Validation, Enablement & Operational Maturity; nicht released, kein Scope Lock) — [v1.1 Plan](docs/roadmap/V1_1_PLAN.md) · aktueller WP: **WP-152 – Token Efficiency & Context Budget Baseline** ([Guide](docs/guides/TOKEN_EFFICIENCY_AND_CONTEXT_BUDGET_BASELINE.md)); WP-151 abgeschlossen
...
- **v1.1:** planning started (Validation, Enablement & Operational Maturity; not released, no scope lock) — [v1.1 plan](docs/roadmap/V1_1_PLAN.md) · current WP: **WP-152 – Token Efficiency & Context Budget Baseline** ([guide](docs/guides/TOKEN_EFFICIENCY_AND_CONTEXT_BUDGET_BASELINE.md)); WP-151 completed
