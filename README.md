...
- **Foundation 0.8:** scope-locked als Agent Enablement & Context Economy (Fokus: Context Economy + Skill Security + Skills MVP Design; Skills-MVP-Implementierung optional; [ADR-0032](docs/adr/ADR-0032-skill-security-policy.md) angenommen; Release Readiness Review abgeschlossen — bereit für Release Prep; nicht released, kein v1.0, kein aktives Skill Pack) — [Plan](docs/roadmap/FOUNDATION_0_8_PLAN.md) · [Scope Lock](docs/roadmap/FOUNDATION_0_8_SCOPE_LOCK.md) · [Readiness Review](docs/release/FOUNDATION_0_8_READINESS_REVIEW.md) · [WP-Queue](docs/roadmap/FOUNDATION_0_8_WORK_PACKAGES.md)
...
- **Foundation 0.8:** scope-locked as Agent Enablement & Context Economy (focus: context economy + skill security + skills MVP design; skills MVP implementation optional; [ADR-0032](docs/adr/ADR-0032-skill-security-policy.md) accepted; release readiness review completed — ready for release prep; not released, not v1.0, no active skill pack) — [Plan](docs/roadmap/FOUNDATION_0_8_PLAN.md) · [Scope Lock](docs/roadmap/FOUNDATION_0_8_SCOPE_LOCK.md) · [Readiness Review](docs/release/FOUNDATION_0_8_READINESS_REVIEW.md) · [WP queue](docs/roadmap/FOUNDATION_0_8_WORK_PACKAGES.md)
