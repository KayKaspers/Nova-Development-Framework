...
- **Foundation 0.3:** ist für das geplante `v0.3.0-foundation` Foundation Pre-Release vorbereitet — [Release Notes](docs/release/FOUNDATION_0_3_RELEASE_NOTES.md) · [Go/No-Go](docs/release/FOUNDATION_0_3_GO_NO_GO_CHECKLIST.md)
...
- **Foundation 0.3:** is prepared for the planned `v0.3.0-foundation` foundation pre-release — [Release Notes](docs/release/FOUNDATION_0_3_RELEASE_NOTES.md) · [Go/No-Go](docs/release/FOUNDATION_0_3_GO_NO_GO_CHECKLIST.md)
