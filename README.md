...
- **Foundation 0.6:** ist für das geplante `v0.6.0-foundation` Foundation Pre-Release vorbereitet (Adoptionsvertrauen & Governance-Härtung; [ADR Policy](docs/adr/ADR_POLICY.md) angenommen, kein v1.0) — [Release Notes](docs/release/FOUNDATION_0_6_RELEASE_NOTES.md) · [Go/No-Go](docs/release/FOUNDATION_0_6_GO_NO_GO_CHECKLIST.md) · [Plan](docs/roadmap/FOUNDATION_0_6_PLAN.md) · [v1.0-Pfad](docs/roadmap/V1_0_PATH_SUMMARY.md)
