---
id: reference-project-rpi-wp-002-docs-status-stability
title: Reference Project docs-status Stability
version: 0.1
...
# Claude Prompt – Reference Project docs-status Stability

## Rolle

Du bist Claude und arbeitest vorsichtig im Referenzprojekt-Repository.
