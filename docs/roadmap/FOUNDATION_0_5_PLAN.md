...
| P1 | Independent Adapter Validation Run (NDF-WP-074): tatsächlicher unabhängiger Durchlauf — umgesetzt: **PASS WITH NOTES** ([independent-runs/2026-07-06](../validation/project-adapter/independent-runs/2026-07-06-private-reference-validation/README.md), Ventil nicht benötigt) |
