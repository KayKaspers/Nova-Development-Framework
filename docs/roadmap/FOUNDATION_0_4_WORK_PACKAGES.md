...
| NDF-WP-059 | Adapter Conventions Polish | docs-only | P1 | WP-047-Backlog 1–3 umsetzen: Manifest-Format-Konvention, Health-Score-Kategorien, Output-Pfad-Konvention; dazu Präfix-Beispiel und First-Safe-WP-Template | WP-058 | **release-blocking** (Kern: Adoption Hardening) | nein |
