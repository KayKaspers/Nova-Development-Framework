...
| NDF-WP-101 | Project Adapter Convention Stability Review | Kern v1.0 Path Consolidation; hebt das Stabilitäts-Kriterium Richtung `met with notes` — **durchgeführt am 2026-07-08: Stable with notes** (`docs/validation/project-adapter/PROJECT_ADAPTER_CONVENTION_STABILITY_REVIEW.md`) |
