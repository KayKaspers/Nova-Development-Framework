...
| NDF-WP-082 | Foundation 0.5 Release Prep | docs-only / release-prep | Release | Release Notes, Kriterien-Abschluss, Go/No-Go, Tagging-Guide für `v0.5.0-foundation` | WP-081 | **release-blocking** — done: `v0.5.0-foundation` veröffentlicht 2026-07-07; Post-Release-Cleanup in WP-083 | nein |
