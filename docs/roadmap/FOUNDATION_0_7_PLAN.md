...
Dieser Plan definiert den Umfang für Foundation 0.7 (Ergebnis von NDF-WP-097). **Status-Update: veröffentlicht als `v0.7.0-foundation` Foundation Pre-Release am 2026-07-08** (NDF-WP-106) — verbindliche Einstufung: [FOUNDATION_0_7_SCOPE_LOCK.md](FOUNDATION_0_7_SCOPE_LOCK.md). Release-blocking waren nur 098, 099 (Checklist-Entscheidung — **erledigt: Option B, optional mit finaler Begründung**, [FOUNDATION_0_7_CHECKLIST_DE_EN_DECISION.md](FOUNDATION_0_7_CHECKLIST_DE_EN_DECISION.md)), 100 (v1.x Compatibility Policy — **erledigt: [ADR-0031](../adr/ADR-0031-v1x-compatibility-policy.md) angenommen**, volle Zusage erst mit v1.0), 101 (Convention Stability — **erledigt: Stable with notes**, [Review](../validation/project-adapter/PROJECT_ADAPTER_CONVENTION_STABILITY_REVIEW.md)), 104 (**erledigt: GO WITH NOTES**, [Readiness Review](../release/FOUNDATION_0_7_RELEASE_READINESS_REVIEW.md)), 105 (**erledigt**: [Release Notes](../release/FOUNDATION_0_7_RELEASE_NOTES.md), Go/No-Go, Tagging-Guide). Foundation 0.7 ist **veröffentlicht, aber nicht v1.0**; die volle v1.x-Kompatibilitätszusage ist vor einem künftigen v1.0-Release nicht aktiv. Möglicher späterer Evolutionsschritt (kein Scope): NDF Agent Enablement & Context Economy inkl. kleinem public-neutralen Claude Skills Pack.
