...
| NDF-WP-110 | NDF Skill Security Policy / ADR-0032 | docs-only / adr-policy | Security-/Human-Gate-Regeln für Skills; **ADR-0032 wird hier erstellt**; fail closed, keine Git-/Release-/Netz-/Secret-Zugriffe | **release-blocking** — **nächster Schritt** (ADR-0032 expected in WP-110) |
