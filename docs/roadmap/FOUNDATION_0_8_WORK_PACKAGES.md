...
| NDF-WP-111 | NDF Claude Skills Pack MVP Design | docs-only / design | Design des kleinen public-neutralen MVP-Skill-Sets (Struktur, Grenzen, Human-Gates, Rückmeldung an Nova) — **nur Design** | **release-blocking** — **nächster Schritt** |
