...
| NDF-WP-086 | ADR Policy Decision | docs-only / adr-policy | ADR-Policy **entscheiden**: Nummernraum, Ablageort, Altbestand — oder ehrlich streichen; nur Entscheidung/Plan, keine Migration | WP-085 | **release-blocking** — Entscheidungspflicht: Policy annehmen **oder** ehrlich streichen; „später" unzulässig (Scope Lock) | WP-063/076, zweimal verschoben |
| NDF-WP-087 | Public SampleProject Runbook Validation Preparation | docs-only | Nur falls nötig: WP-073-Unterlagen für den öffentlichen Fixture-Lauf nachschärfen (Erwartung: minimal, Unterlagen sind nutzbar) | WP-085 | optional (nur falls nötig — skipped, wenn WP-088 mit den WP-073-Unterlagen startet) | WP-073 |
| NDF-WP-088 | Public SampleProject Runbook Validation Run | review-only | Runbook-basierter unabhängiger Lauf gegen das **öffentliche** Fixture; hebt v1.0-External-Validation Richtung `met` | WP-085 (+087 falls nötig) | **release-blocking mit Downgrade-Ventil** über WP-094 — 8 Bedingungen verbindlich in [FOUNDATION_0_6_SCOPE_LOCK.md](FOUNDATION_0_6_SCOPE_LOCK.md) | WP-074-Note IAV-002, v1.0-tracked |
