...
> **Post-release note:** `v0.4.0-foundation` wurde am 2026-07-04 veröffentlicht (GitHub Pre-Release, Titel „Nova Development Framework v0.4.0 Foundation", read-only verifiziert); Tag nicht neu erstellen oder verschieben. Diese Anleitung bleibt als Referenz für künftige Releases erhalten. / published 2026-07-04; do not recreate or move the tag.
