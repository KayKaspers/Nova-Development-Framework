...
> **Status: abgeschlossen / archived (post-release historical document).** Der Release `v0.6.0-foundation` wurde am 2026-07-07 veröffentlicht. Diese Checkliste bleibt als historischer Nachweis und Vorlage für künftige Releases erhalten — keine neuen Aktionen daraus ableiten. / Foundation 0.6 was released as `v0.6.0-foundation`; retained for audit/history.
