# Reference Project First Integration Baseline
...
Referenzprojekt B wird als erstes echtes Projekt genutzt, um das Nova Development Framework praktisch zu validieren.
...
Referenzprojekt B ist als erstes Referenzprojekt geeignet, weil es bereits echte technische und organisatorische Eigenschaften besitzt:
...
Referenzprojekt B soll eine NDF Project System Baseline erhalten:
...
## Bekannter Referenzprojekt-Stand
...
Dieses Paket liefert noch keine vollständige Referenzprojekt-Integration im Referenzprojekt-Repo.  
Es liefert die NDF-seitige Referenz, wie diese Integration sauber erfolgen soll.

## Nächster Schritt

Ein separates Referenzprojekt-Repo-Paket oder Claude-Prompt erzeugen, der in Referenzprojekt B selbst die Project-System-Dateien erstellt.
