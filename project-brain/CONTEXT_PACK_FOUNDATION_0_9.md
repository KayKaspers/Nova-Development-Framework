...
**Released / published — reconciliation documented** als `v0.9.0-foundation` (2026-07-10, NDF-WP-133). Nicht v1.0, kein v1.0 Release Candidate, keine aktive volle v1.x-Zusage. Ein **docs-only Skills-Pack** liegt unter `.claude/skills/` — seit WP-129 vier Core-MVP-Skills, seit WP-137 vier Extended-Core-Skills, seit WP-145 zusätzlich 22 Advisory-Skills (**30 gesamt**) — additiv, ADR-0032-konform, ohne Scripts/Automation/Netz/Secrets; keine autonom ausführenden Skills. Seit WP-134 gilt der **Skills-first Operating Mode**: Standard Prompt Mode als Default, Full nur für kritische Fälle (Security/Release/ADR/v1.0/neue Skills); DSK-001 Partially closed.

## Last Completed Work Package

`NDF-WP-145 – Remaining Docs-only Skills Pack Implementation` — GO WITH NOTES – remaining docs-only skills implemented; 22 neue docs-only Advisory-Skills über fünf Familien (Core/Governance/Release, Docs/Communication, Engineering/Architecture, Product/UX/Adoption [Ethical-use-Grenzen], Creative/Branding/Content); Skill-Pack nun **30 Skills**; bestehende 8 unverändert (nur README-Index ergänzt); kein `ndf-prompt-mode-selector`, keine Automation/Netz/API/OAuth/MCP/Secrets/privaten Daten/Git-Release-Aktionen; **RC `v1.0.0-rc.1` unverändert; kein v1.0 final; keine volle v1.x-Zusage**; ADR-0031/0032 unverändert. Doc: `docs/validation/v1-0/REMAINING_DOCS_ONLY_SKILLS_PACK_VALIDATION.md`.

## Next Work Package

**NDF-WP-146 – v1.0 Final Readiness Review** (Final Readiness mit dem erweiterten 30-Skill-Pack; bezieht RC-Feedback-Fenster + G-13-Wegwahl A/B/C + ECS-001 ein; Check gegen Final-Kriterien F-01…F-07; Full/Skill-assisted Full Prompt Mode, Opus 4.8). Danach WP-147 v1.0 Final Release Prep → manueller v1.0-Final-Release (Human Maintainer). Optional vor WP-146 nur bei G-13-Weg A: dedizierter Final External Validation / Neutral Sample Re-Run (nicht blockierend). WP-130/131/132 bleiben optional/nicht aktiviert.
...
- WP-145: Remaining Docs-only Skills Pack Implementation — **GO WITH NOTES – remaining docs-only skills implemented** ([Validation](../docs/validation/v1-0/REMAINING_DOCS_ONLY_SKILLS_PACK_VALIDATION.md)); 22 neue docs-only Advisory-Skills (Core/Governance/Release 4, Docs 2, Engineering 5, Product/UX/Adoption 5 [Ethical-use-Grenzen], Creative/Branding/Content 6); Skill-Pack nun **30 Skills**; je 13 Pflichtfelder + familienspezifisches Feld 14; bestehende 8 unverändert; ausgeschlossen: `ndf-prompt-mode-selector`, Git-/Release-/Netz-/API-/OAuth-/MCP-/Secret-/Payment-/Social-/Offensive-Security-/Multi-Agent-Automation, private Projektlogik, Scripts; RC unverändert; kein v1.0 final; keine volle v1.x-Zusage; ADR-0031/0032 unverändert. Final Readiness → WP-146.

## Next Prompt Recommendation

**Full oder Skill-assisted Full Prompt Mode** für **NDF-WP-146 – v1.0 Final Readiness Review** (Final Readiness mit dem erweiterten 30-Skill-Pack; bezieht RC-Feedback-Fenster + G-13-Wegwahl A/B/C + ECS-001 ein; Check gegen F-01…F-07; empfohlenes Modell Claude Opus 4.8). Danach WP-147 v1.0 Final Release Prep → manueller v1.0-Final-Release. WP-130/131/132 bleiben optional/nicht aktiviert.
