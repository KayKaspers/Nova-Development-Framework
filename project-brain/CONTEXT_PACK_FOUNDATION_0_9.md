...
**Released / published — reconciliation documented** als `v0.9.0-foundation` (2026-07-10, NDF-WP-133). Nicht v1.0, kein v1.0 Release Candidate, keine aktive volle v1.x-Zusage. Ein **docs-only Skills-Pack** liegt unter `.claude/skills/` — seit WP-129 vier Core-MVP-Skills, seit WP-137 vier Extended-Core-Skills, seit WP-145 22 Advisory-Skills, seit WP-146 acht weitere Advisory-Skills (**38 gesamt**) — additiv, ADR-0032-konform, ohne Scripts/Automation/Netz/Secrets; keine autonom ausführenden Skills. Seit WP-134 gilt der **Skills-first Operating Mode**: Standard Prompt Mode als Default, Full nur für kritische Fälle (Security/Release/ADR/v1.0/neue Skills); DSK-001 Partially closed.

## Last Completed Work Package

`NDF-WP-146 – Additional Docs-only Skills Pack Implementation` — GO WITH NOTES – additional docs-only skills implemented; 8 neue docs-only Advisory-Skills (`ndf-validation-evidence-reviewer`, `ndf-skill-trigger-quality-reviewer`, `ndf-skill-supply-chain-risk-reviewer`, `ndf-public-release-body-reviewer`, `ndf-feedback-triage-runner`, `ndf-accessibility-reviewer`, `ndf-privacy-data-minimization-reviewer`, `ndf-project-adapter-quality-reviewer`); Skill-Pack nun **38 Skills**; je 14 Pflichtfelder; bestehende 30 unverändert (nur README-Index ergänzt); kein `ndf-prompt-mode-selector`, keine Automation/Netz/API/OAuth/MCP/Secrets/privaten Daten/Git-Release-Aktionen, keine fremden Skills 1:1; **RC `v1.0.0-rc.1` unverändert; kein v1.0 final; keine volle v1.x-Zusage**; ADR-0031/0032 unverändert. Doc: `docs/validation/v1-0/ADDITIONAL_DOCS_ONLY_SKILLS_PACK_VALIDATION.md`.

## Next Work Package

**NDF-WP-147 – v1.0 Final Readiness Review** (Final Readiness mit dem erweiterten 38-Skill-Pack; bezieht RC-Feedback-Fenster + G-13-Wegwahl A/B/C + ECS-001/ADS-001 ein; Check gegen Final-Kriterien F-01…F-07; Full/Skill-assisted Full Prompt Mode, Opus 4.8). Danach WP-148 v1.0 Final Release Prep → manueller v1.0-Final-Release (Human Maintainer). Optional vor WP-147 nur bei G-13-Weg A: dedizierter Final External Validation / Neutral Sample Re-Run (nicht blockierend). WP-130/131/132 bleiben optional/nicht aktiviert.
...
- WP-146: Additional Docs-only Skills Pack Implementation — **GO WITH NOTES – additional docs-only skills implemented** ([Validation](../docs/validation/v1-0/ADDITIONAL_DOCS_ONLY_SKILLS_PACK_VALIDATION.md)); 8 neue docs-only Advisory-Skills (Evidence/Validation, Skill Trigger Quality, Skill Supply Chain Risk, Public Release Body, Feedback Triage, Accessibility, Privacy/Data-Minimization, Project Adapter Quality); Skill-Pack nun **38 Skills**; je 14 Pflichtfelder (inkl. „Specific risk boundaries"); bestehende 30 unverändert; ausgeschlossen: `ndf-prompt-mode-selector`, alle Automation/Netz/API/OAuth/MCP/Secret/Git-Release-Skills, fremde Skills 1:1, unklare Lizenz; RC unverändert; kein v1.0 final; keine volle v1.x-Zusage; ADR-0031/0032 unverändert. Final Readiness → WP-147.

## Next Prompt Recommendation

**Full oder Skill-assisted Full Prompt Mode** für **NDF-WP-147 – v1.0 Final Readiness Review** (Final Readiness mit dem erweiterten 38-Skill-Pack; bezieht RC-Feedback-Fenster + G-13-Wegwahl A/B/C + ECS-001/ADS-001 ein; Check gegen F-01…F-07; empfohlenes Modell Claude Opus 4.8). Danach WP-148 v1.0 Final Release Prep → manueller v1.0-Final-Release. WP-130/131/132 bleiben optional/nicht aktiviert.
