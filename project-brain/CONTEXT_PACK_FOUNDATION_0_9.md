...
**NDF-WP-157 – Public Documentation Polish** als eigener, vollständiger Ausführungsprompt mit Execution Header (`SESSION`/`STATUS`) — bis dahin keine autorisierte Ausführung. Die Nova-Review von WP-156 ist bestanden; WP-157 darf jedoch nicht vor der Human-Maintainer-Annahme (Commit) von WP-156 starten. Consumer mit Integrity Locks re-verifizieren die sechs in WP-154 geänderten Skills vor normativer Nutzung. ADR-0032-Consumer-Scope nur per separater, eigens autorisierter ADR. WP-130/131/132 bleiben optional/nicht aktiviert.
