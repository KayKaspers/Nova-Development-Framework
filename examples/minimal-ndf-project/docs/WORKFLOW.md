...
5. Maintainer committet und pusht
6. Nova reviewed den Stand
```

## Regeln

- keine großen Arbeitspakete
- keine automatischen Git-Operationen durch KI
- keine unklaren Änderungen
